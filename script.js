...
function renderAdminTasks() {
    ...
    appData.tasks.forEach((task, index) => {
        ...
        const answersHtml = task.type === 'multiple-choice' 
            ...
            : `<div class="answers-section" style="margin-top: 15px;">
                    <p style="color: #667eea; font-weight: 600; font-size: 0.9em;">✏️ Students will type their answer</p>
        ...
        <div class="task-card">
            <div style="display: flex; justify-content: space-between; align-items: start;">
                ...
                <span style="background: #667eea; color: white; padding: 6px 12px; border-radius: 20px; font-size: 12px; font-weight: 600; white-space: nowrap; margin-left: 15px;">
                    ${typeLabel}
                </span>
            </div>
            ${answersHtml}
        ...
        <div style="background: white; color: #333; padding: 16px; border-radius: 8px; margin-bottom: 15px; text-align: left; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            <div style="display: flex; align-items: start; gap: 12px;">
                ...
                <div style="flex: 1;">
                    ...
                    <p style="margin: 0; font-size: 14px; background: #f5f5f5; padding: 10px; border-left: 3px solid #667eea; border-radius: 4px;">
            ...
            html += `<div class="submission-item">
                <div style="display: flex; align-items: start; gap: 10px;">
                    ...
                    <div style="flex: 1;">
                        ...
                        <div style="background: #f5f5f5; border-left: 3px solid #667eea; padding: 10px; margin-top: 8px; border-radius: 4px;">
